...
const CITIES = [
    ...
    {n:'Sydney',lat:-33.87,lon:151.21,mood:'joy'}
];
...
// 5. WINDOW-LEVEL FUNCTIONS (For HTML buttons)
...
window.submitMood = async () => {
    ...
    document.getElementById('ov-sub').textContent = `Your signature: "${word}"`;
...
async function boot(){
    ...
    } catch(e) { console.warn("Location detection blocked or failed."); }
